```
#access module
theia@theia-vuxminhan:/home/project$ cd /home/project
theia@theia-vuxminhan:/home/project$ wget https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-LX0117EN-SkillsNetwork/labs/module%201/usdoi.txt
theia@theia-vuxminhan:/home/project$ ls -l usdoi.txt
-rw-r--r-- 1 theia users 8121 Sep 28  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ chmod -r usdoi.txt               
theia@theia-vuxminhan:/home/project$ ls -l usdoi.txt
--w------- 1 theia users 8121 Sep 28  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ chmod +r usdoi.txt               
theia@theia-vuxminhan:/home/project$ ls -l usdoi.txt
-rw-r--r-- 1 theia users 8121 Sep 28  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ chmod o-r usdoi.txt
theia@theia-vuxminhan:/home/project$ ls -l usdoi.txt
-rw-r----- 1 theia users 8121 Sep 28  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ cd /home/project
theia@theia-vuxminhan:/home/project$ mkdir test
theia@theia-vuxminhan:/home/project$ ls -l
total 16
drwxr-sr-x 2 theia users 4096 Sep 15 13:42 scripts
drwxr-sr-x 2 theia users 4096 Sep 15 13:58 test
-rw-r----- 1 theia users 8121 Sep 28  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ cd test
theia@theia-vuxminhan:/home/project/test$ mkdir test2
theia@theia-vuxminhan:/home/project/test$ cd ../
theia@theia-vuxminhan:/home/project$ chmod u-x test
theia@theia-vuxminhan:/home/project$ cd test
bash: cd: test: Permission denied
theia@theia-vuxminhan:/home/project$ ls -l
total 16
drwxr-sr-x 2 theia users 4096 Sep 15 13:42 scripts
drw-r-sr-x 3 theia users 4096 Sep 15 13:59 test
-rw-r----- 1 theia users 8121 Sep 28  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ mkdir test/test3
mkdir: cannot create directory ‘test/test3’: Permission denied
theia@theia-vuxminhan:/home/project$ chmod u+x test
theia@theia-vuxminhan:/home/project$ chmod u-w test
theia@theia-vuxminhan:/home/project$ ls -l
total 16
drwxr-sr-x 2 theia users 4096 Sep 15 13:42 scripts
dr-xr-sr-x 3 theia users 4096 Sep 15 13:59 test
-rw-r----- 1 theia users 8121 Sep 28  2022 usdoi.txt

#archieve module 
theia@theia-vuxminhan:/home/project$ tar -cvf bin.tar /bin
...
/bin/lessfile
/bin/lessecho
theia@theia-vuxminhan:/home/project$ tar -tvf bin.tar
...
theia@theia-vuxminhan:/home/project$ tar -xvf bin.tar
bin/
bin/zdiff
bin/su
bin/more
...
-rw-r--r-- 1 theia users 5703680 Sep 16 09:45 bin.tar
-rw-r--r-- 1 theia users    8121 Sep 21  2022 usdoi.txt
theia@theia-vuxminhan:/home/project$ zip config.zip /etc/*.conf
...
theia@theia-vuxminhan:/home/project$ zip -r bin.zip /bin
  adding: bin/ (stored 0%)
...
theia@theia-vuxminhan:/home/project$ unzip -l config.zip
Archive:  config.zip
